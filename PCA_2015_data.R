...
f<-read.csv("C:/Users/sushbiswal/Desktop/PAM/PAM-2. Raw Data/Combined_Data/data_2015_final.csv")

f<-read.csv("C:/Users/sushbiswal/Desktop/PAM/PAM-2. Raw Data/Combined_Data/data_2015_final_1382018.csv")
library(princomp)
...
pc2$scores
write.csv(new,"C:/Users/sushbiswal/Desktop/PAM/PAM-2. Raw Data/Combined_Data/Data_2015_PCA.csv")
### writing 
unique(new$RC1)